 ...
 */
router.get('/getGroup/:id', authMiddleware, GroupController.getGroupByName);
 ...
 *         description: Server error
 */
router.put('/updateGroup/:name', authMiddleware, GroupController.updateGroup);
 ...
 *         description: Server error
 */
router.post('/addProduct/:id', authMiddleware, GroupController.addProduct);
 ...
 *         description: Server error
 */
router.delete('/deleteGroup/:id', authMiddleware, GroupController.deleteGroup);
